...
if ( ! class_exists( 'SP_WQV_Framework_Field_switcher' ) ) {
	class SP_WQV_Framework_Field_switcher extends SP_WQV_Framework_Fields {
		...
		public function render() {
			...
			$text_on    = ( ! empty( $this->field['text_on'] ) ) ? $this->field['text_on'] : esc_html__( 'On', 'woo-quick-view' );
			$text_off   = ( ! empty( $this->field['text_off'] ) ) ? $this->field['text_off'] : esc_html__( 'Off', 'woo-quick-view' );
