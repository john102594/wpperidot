	...
	class SP_WQV_Framework_Field_typography extends SP_WQV_Framework_Fields {
		...
		public function render() {
			...
			if ( ! empty( $args['font_family'] ) ) {
				...
				echo '<div class="sp_wqvp--title">' . esc_html__( 'Font Family', 'woo-quick-view' ) . '</div>';
				echo $this->create_select( array( $this->value['font-family'] => $this->value['font-family'] ), 'font-family', esc_html__( 'Select a font', 'woo-quick-view' ) );
				echo '</div>';
			}
			...
			if ( ! empty( $args['backup_font_family'] ) ) {
				...
				echo '<div class="sp_wqvp--title">' . esc_html__( 'Backup Font Family', 'woo-quick-view' ) . '</div>';
				echo $this->create_select(
					...
					'backup-font-family',
					esc_html__( 'Default', 'woo-quick-view' )
				);
				echo '</div>';
			}
			...
			if ( ! empty( $args['font_weight'] ) || ! empty( $args['font_style'] ) ) {
				...
				echo '<div class="sp_wqvp--title">' . esc_html__( 'Font Style', 'woo-quick-view' ) . '</div>';
				echo '<select class="sp_wqvp--font-style-select" data-placeholder="Default">';
				echo '<option value="">' . ( ! $this->chosen ? esc_html__( 'Default', 'woo-quick-view' ) : '' ) . '</option>';
				...
				if ( ! empty( $args['extra_styles'] ) ) {
					...
					echo ( ! $this->chosen ) ? '<div class="sp_wqvp--title">' . esc_html__( 'Load Extra Styles', 'woo-quick-view' ) . '</div>' : '';
					$placeholder = ( $this->chosen ) ? esc_html__( 'Load Extra Styles', 'woo-quick-view' ) : esc_html__( 'Default', 'woo-quick-view' );
			...
			if ( ! empty( $args['subset'] ) ) {
				...
				echo '<div class="sp_wqvp--title">' . esc_html__( 'Subset', 'woo-quick-view' ) . '</div>';
				$subset = ( is_array( $this->value['subset'] ) ) ? $this->value['subset'] : array_filter( (array) $this->value['subset'] );
				echo $this->create_select( $subset, 'subset', esc_html__( 'Default', 'woo-quick-view' ), $args['multi_subset'] );
				echo '</div>';
			}
			...
			if ( ! empty( $args['text_align'] ) ) {
				echo '<div class="sp_wqvp--block">';
				echo '<div class="sp_wqvp--title">' . esc_html__( 'Text Align', 'woo-quick-view' ) . '</div>';
				echo $this->create_select(
					array(
						'inherit' => esc_html__( 'Inherit', 'woo-quick-view' ),
						'left'    => esc_html__( 'Left', 'woo-quick-view' ),
						'center'  => esc_html__( 'Center', 'woo-quick-view' ),
						'right'   => esc_html__( 'Right', 'woo-quick-view' ),
						'justify' => esc_html__( 'Justify', 'woo-quick-view' ),
						'initial' => esc_html__( 'Initial', 'woo-quick-view' ),
					),
					'text-align',
					esc_html__( 'Default', 'woo-quick-view' )
				);
			...
			if ( ! empty( $args['font_variant'] ) ) {
				echo '<div class="sp_wqvp--block">';
				echo '<div class="sp_wqvp--title">' . esc_html__( 'Font Variant', 'woo-quick-view' ) . '</div>';
				echo $this->create_select(
					array(
						'normal'         => esc_html__( 'Normal', 'woo-quick-view' ),
						'small-caps'     => esc_html__( 'Small Caps', 'woo-quick-view' ),
						'all-small-caps' => esc_html__( 'All Small Caps', 'woo-quick-view' ),
					),
					'font-variant',
					esc_html__( 'Default', 'woo-quick-view' )
				);
			...
			if ( ! empty( $args['text_transform'] ) ) {
				echo '<div class="sp_wqvp--block">';
				echo '<div class="sp_wqvp--title">' . esc_html__( 'Text Transform', 'woo-quick-view' ) . '</div>';
				echo $this->create_select(
					array(
						'none'       => esc_html__( 'None', 'woo-quick-view' ),
						'capitalize' => esc_html__( 'Capitalize', 'woo-quick-view' ),
						'uppercase'  => esc_html__( 'Uppercase', 'woo-quick-view' ),
						'lowercase'  => esc_html__( 'Lowercase', 'woo-quick-view' ),
					),
					'text-transform',
					esc_html__( 'Default', 'woo-quick-view' )
				);
			...
			if ( ! empty( $args['text_decoration'] ) ) {
				echo '<div class="sp_wqvp--block">';
				echo '<div class="sp_wqvp--title">' . esc_html__( 'Text Decoration', 'woo-quick-view' ) . '</div>';
				echo $this->create_select(
					array(
						'none'               => esc_html__( 'None', 'woo-quick-view' ),
						'underline'          => esc_html__( 'Solid', 'woo-quick-view' ),
						'underline double'   => esc_html__( 'Double', 'woo-quick-view' ),
						'underline dotted'   => esc_html__( 'Dotted', 'woo-quick-view' ),
						'underline dashed'   => esc_html__( 'Dashed', 'woo-quick-view' ),
						'underline wavy'     => esc_html__( 'Wavy', 'woo-quick-view' ),
						'underline overline' => esc_html__( 'Overline', 'woo-quick-view' ),
						'line-through'       => esc_html__( 'Line-through', 'woo-quick-view' ),
					),
					'text-decoration',
					esc_html__( 'Default', 'woo-quick-view' )
				);
			...
			if ( ! empty( $args['font_size'] ) ) {
				echo '<div class="sp_wqvp--block">';
				echo '<div class="sp_wqvp--title">' . esc_html__( 'Font Size', 'woo-quick-view' ) . '</div>';
			...
			if ( ! empty( $args['line_height'] ) ) {
				echo '<div class="sp_wqvp--block">';
				echo '<div class="sp_wqvp--title">' . esc_html__( 'Line Height', 'woo-quick-view' ) . '</div>';
				echo '<div class="sp_wqvp--input-wrap">';
			...
			if ( ! empty( $args['letter_spacing'] ) ) {
				echo '<div class="sp_wqvp--block">';
				echo '<div class="sp_wqvp--title">' . esc_html__( 'Letter Spacing', 'woo-quick-view' ) . '</div>';
				echo '<div class="sp_wqvp--input-wrap">';
			...
			if ( ! empty( $args['word_spacing'] ) ) {
				echo '<div class="sp_wqvp--block">';
				echo '<div class="sp_wqvp--title">' . esc_html__( 'Word Spacing', 'woo-quick-view' ) . '</div>';
				echo '<div class="sp_wqvp--input-wrap">';
			...
			if ( ! empty( $args['color'] ) || ! empty( $args['hover_color'] )) {
				...
				if ( ! empty( $args['color'] ) ) {
					...
					echo '<div class="sp_wqvp--title">' . esc_html__( 'Font Color', 'woo-quick-view' ) . '</div>';
				...
				if ( ! empty( $args['hover_color'] ) ) {
					...
					echo '<div class="sp_wqvp--block sp_wqvp--block-font-color">';
					echo '<div class="sp_wqvp--title">' . esc_html__( 'Hover Color', 'woo-quick-view' ) . '</div>';
					echo '<div class="sp_wqvp-field-color">';
			...
			if ( ! empty( $args['margin-top'] ) ) {
				...
				echo '<div class="sp_wqvp--title">' . esc_html__( 'Margin Top', 'woo-quick-view' ) . '</div>';
			...
			if ( ! empty( $args['margin-bottom'] ) ) {
				echo '<div class="sp_wqvp--block sp_wqvp--block-margin">';
				echo '<div class="sp_wqvp--title">' . esc_html__( 'Margin Bottom', 'woo-quick-view' ) . '</div>';
				echo '<div class="sp_wqvp--blocks">';
			...
			if ( ! empty( $args['custom_style'] ) ) {
				...
				echo '<div class="sp_wqvp--title">' . esc_html__( 'Custom Style', 'woo-quick-view' ) . '</div>';
			...
			if ( ! wp_script_is( 'sp_wqvp-webfontloader' ) ) {
				...
				if ( ! empty( $customwebfonts ) ) {
					$webfonts['custom'] = array(
						'label' => esc_html__( 'Custom Web Fonts', 'woo-quick-view' ),
						'fonts' => $customwebfonts,
					);
				}

				$webfonts['safe'] = array(
					'label' => esc_html__( 'Safe Web Fonts', 'woo-quick-view' ),
					'fonts' => apply_filters(
				...
				$webfonts['google'] = array(
					'label' => esc_html__( 'Google Web Fonts', 'woo-quick-view' ),
					'fonts' => apply_filters(
