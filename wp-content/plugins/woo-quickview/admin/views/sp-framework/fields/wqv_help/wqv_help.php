...
if ( ! class_exists( 'SP_WQV_Framework_Field_wqv_help' ) ) {
	class SP_WQV_Framework_Field_wqv_help extends SP_WQV_Framework_Fields {
		...
		<div class="wrap about-wrap sp-wqv-help">
			<h1><?php echo esc_html__( 'Welcome to WooCommerce Quick View!', 'woo-quick-view' ); ?></h1>
			<p class="about-text">
			<?php
			echo esc_html__( 'Get introduced to WooCommerce Quick View plugin by watching our "Getting Started" video tutorial series. This video will help you get started with the plugin.', 'woo-quick-view' );
			?>
				</p>
